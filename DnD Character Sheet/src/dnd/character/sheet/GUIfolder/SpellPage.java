 ...
 * @author thoma
 */
public class SpellPage extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpellPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
